...
async function getAirport(id){
    try {
        ...
        throw new AppError('Cannot fetch data of the specified airport', StatusCodes.INTERNAL_SERVER_ERROR);
    }
}
...
async function destroyAirport(id){
    try {
        ...
        throw new AppError('Cannot delete the specified airport', StatusCodes.INTERNAL_SERVER_ERROR);
    }
}
module.exports = {
    createAirport,
